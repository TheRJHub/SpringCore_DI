...
--> Automatic bean detection using @Component
--> Bean retrieval from the Spring ApplicationContext
--> Demonstrates best practices for dependency injection
--> Manual and automated value assignment (via setters or properties)
